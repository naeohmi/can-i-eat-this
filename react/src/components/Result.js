     ...
     if(this.state.issues["shellfishallergy"]){
      ...
      console.log(this.state.findings);
          this.setState((previousState) => {
            previousState.findings.eggs = eggs;
            previousState.findings.milk = milk;
            previousState.findings.fish = fish;
            previousState.findings.peanuts = peanuts;
            previousState.findings.sesame = sesame;
            previousState.findings.shellfish = shellfish;
            previousState.findings.soy = soy;
            previousState.findings.treenuts = treenuts;
            previousState.findings.wheat = wheat;
            previousState.findings.result = result;
